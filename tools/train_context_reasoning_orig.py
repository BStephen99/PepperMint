...
def train(cfg):
    ...
    #train_loader1 = DataLoader(GraphDataset("/home2/bstephenson/GraVi-T/data/graphs/RESNET18-TSM-ALL_csi_30.0_0.9/AVAtrain"), batch_size=cfg['batch_size'], shuffle=True)
    #train_loader2 = DataLoader(GraphDataset("/home2/bstephenson/GraVi-T/data/graphs/RESNET18-TSM-ALL_csi_30.0_0.9/WASDtrain"), batch_size=cfg['batch_size'], shuffle=True)
    #train_loader3 = DataLoader(GraphDataset("/home2/bstephenson/GraVi-T/data/graphs/RESNET18-TSM-ALL_csi_30.0_0.9/ours"), batch_size=cfg['batch_size'], shuffle=True)
    #train_loader = DataLoader(train_loader1.dataset + train_loader2.dataset + train_loader3.dataset, batch_size=cfg['batch_size'], shuffle=True)
