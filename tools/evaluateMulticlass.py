...
from gravit.utils.formatterMulticlass import get_formatting_data_dict, get_formatted_preds
...
def evaluate(cfg):
    ...
    with torch.no_grad():
        for i, data in enumerate(val_loader, 1):
            ...
            logits = model(x, edge_index, edge_attr, c, ps, pers, speakerEmb=speakerEmb)
            #print(logits)
