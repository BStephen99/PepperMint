...
class SPELL(Module):
    ...
    def forward(self, x, edge_index, edge_attr, c=None, ps=None, pers=None, gender=None, gaze=None, landmarks=None, dinoEmb=None,speakerEmb=None, numPredSpeakers=None, bodyEmb=None):
        ...
        if self.use_spf:
            ...
            x_visual = self.layer011(bodyEmb)
        else:
            x_visual = self.layer011(x[:, :feature_dim//self.num_modality])
