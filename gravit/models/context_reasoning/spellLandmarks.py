...
class SPELLLAND(Module):
    ...
    def forward(self, x, edge_index, edge_attr, xH=None, c=None, cH=None, ps=None, pers=None, gender=None, gaze=None, landmarks=None, landmarksH=None,speakerEmb=None, numPredSpeakers=None):
